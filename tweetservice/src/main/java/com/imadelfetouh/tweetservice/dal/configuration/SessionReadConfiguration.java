...
public class SessionReadConfiguration {
    ...
    public SessionReadConfiguration() {
        ...
        properties.put(Environment.URL, "jdbc:mysql://"+System.getenv("TWEETSERVICE_MYSQL_REPLICA_HOST")+":"+System.getenv("TWEETSERVICE_MYSQL_REPLICA_PORT")+"/tweetservice?createDatabaseIfNotExist=true");
